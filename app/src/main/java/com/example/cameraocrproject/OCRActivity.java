...
public class OCRActivity extends AppCompatActivity {
    ...
    private String textString = "너와 함께한 모든 시간이 좋았다 날이 좋아서 날이 좋지 않아서 날이 적당해서 모두 좋았다";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ttsBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(detectedTextView.getText().toString().length() > 0){
                    tts.speak(detectedTextView.getText().toString(),TextToSpeech.QUEUE_FLUSH, null);
                }
            }
        });
    ...
    private void inspectFromBitmap(Bitmap bitmap) {
        ...
        try {
            ...
            handler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    detectedTextView.setText(textString);
                }
            }, 5000);
        }
        finally {
